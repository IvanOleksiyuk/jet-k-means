...
def dataset_path_and_pref(DATASET, REVERSE):
    ...
    if REVERSE:
        ...
        tra_data_field, con_data_field = con_data_field, tra_data_field
        bg_val_data_field, sg_val_data_field = sg_val_data_field, bg_val_data_field 
...
def prepare_data(path, crop=None, field=None, preproc=None, SIGMA=0, simple_load=False, reshape=True):     
    #read from pickle
    if path[-6:]=="pickle":
